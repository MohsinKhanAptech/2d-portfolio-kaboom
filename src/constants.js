...
export const dialogueData = {
    ...
    I've made a couple of games in that language. I also like PHP and Python. Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/MohsinKhanAptech" target="_blank">Github</a>!`,
  ...
  I also learned to make this porfolio from youtube. Go sub to <a href="https://youtube.com/@jslegenddev" target="_blank">jslegenddev</a>! (If you like the content)
  ...
  <a href="https://www.youtube.com/@PirateSoftware" target="_blank">PirateSoftware</a> (sometimes) and <a href="https://www.youtube.com/@MelkeyDev" target="_blank">Melkey</a>!`,
	...
	resume: `This is my desk and on it is my resume. <a href="https://github.com/MohsinKhanAptech/Resume/blob/main/Resume.pdf" target="_blank">Check it out?</a>
  Contact me at  <a href="mailto:muhammadmohsinkhan.aptech@gmail.com" target="_blank">muhammadmohsinkhan.aptech@gmail.com</a> if you have any interesting job opportunities!`,
  ...
  Kaboom.js by watching these tutorials <a href="https://youtube.com/@jslegenddev" target="_blank">here</a>.`,
	library: `There are a lot of programming books on my shelves. There is even one in French (I dont speak French).
  I probably only read one of them. Who else compulsively buys technical books without ever finishing them?`,
	exit: `If you want to exit Mohsin's portfolio, just close the tab.`,
};
